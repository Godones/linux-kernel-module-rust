...
//!
//!     fn queue_rq(rq: ARef<Request<Self>>, _is_last: bool) -> KernelResult<()> {
//!         use kbind::KernelResult;use kbind::types::ARef;Request::end_ok(rq);
//!         Ok(())
//!     }
//!
//!     fn commit_rqs() {}
...
mod test {
    ...
    use crate::{
        driver::block::{gen_disk, Operations, Request, TagSet},
        types::ARef,
        KernelResult,
    };
    ...
    fn main() -> KernelResult<()> {
        ...
        let tagset = Arc::pin_init(TagSet::new(1, 256, 1))?.into();
        let mut disk = gen_disk::GenDiskBuilder::new()
            .capacity_sectors(4096)
            .build::<MyBlkDevice>(format_args!("myblk"), tagset)?;
        Ok(())
    }
}
