...
pub mod alloc_flags {
    ...
    pub const __GFP_ZERO: AllocFlags = AllocFlags(bindings::__GFP_ZERO);
    ...
    pub const GFP_ATOMIC: AllocFlags = AllocFlags(bindings::GFP_ATOMIC);

    /// Typical for kernel-internal allocations. The caller requires ZONE_NORMAL or a lower zone
    /// for direct access but can direct reclaim.
    pub const GFP_KERNEL: AllocFlags = AllocFlags(bindings::GFP_KERNEL);
