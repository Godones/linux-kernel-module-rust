...
impl<T> Revocable<T> {
    ...
    pub fn new(data: impl PinInit<T>) -> impl PinInit<Self> {
        pin_init!(Self {
            ...
            data <- unsafe { pin_init_from_closure(move |slot: *mut MaybeUninit<UnsafeCell<T>>| {
                PinInit::<T, core::convert::Infallible>::__pinned_init(data, slot as *mut T)?;
