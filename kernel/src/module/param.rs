    ...
    ($ty:ident) => {
        impl ModuleParam for $ty {
            ...
            fn try_from_param_arg(arg: Option<&'static [u8]>) -> Option<Self> {
                ...
                <$ty as crate::module::param::ParseInt>::from_str(utf8)
            }
...
macro_rules! make_param_ops {
    ...
    ($(#[$meta:meta])* $ops:ident, $ty:ty) => {
        ...
        pub static $ops: $crate::bindings::kernel_param_ops = $crate::bindings::kernel_param_ops {
            flags: if <$ty as $crate::module::param::ModuleParam>::NOARG_ALLOWED {
                $crate::bindings::KERNEL_PARAM_OPS_FL_NOARG
            } else {
                0
            },
            set: Some(<$ty as $crate::module::param::ModuleParam>::set_param),
            get: Some(<$ty as $crate::module::param::ModuleParam>::get_param),
            free: Some(<$ty as $crate::module::param::ModuleParam>::free),
        };
    };
}
